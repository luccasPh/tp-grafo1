...
class Menu(object):
    def setupUi(self, Form):
        ...
        self.label.setPixmap(
            QtGui.QPixmap(os.path.join(os.path.dirname(__file__), "image/logo.png"))
        )
        ...
        self.label_2.setPixmap(
            QtGui.QPixmap(os.path.join(os.path.dirname(__file__), "image/layout1.png"))
        )
        ...
        self.label_3.setPixmap(
            QtGui.QPixmap(os.path.join(os.path.dirname(__file__), "image/layout2.png"))
        )
        ...
        self.label_4.setPixmap(
            QtGui.QPixmap(os.path.join(os.path.dirname(__file__), "image/layout3.png"))
        )
        ...
        self.label_5.setPixmap(
            QtGui.QPixmap(os.path.join(os.path.dirname(__file__), "image/layout4.png"))
        )
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox_2.setTitle(_translate("Form", "LABIRINTO 2", None))

...
class Config(QtWidgets.QWidget):
    def __init__(self, num):
        ...
        with open(
            os.path.join(os.path.dirname(__file__), "layout/layout{}.txt".format(num)),
            "r",
        ) as l:
            layout = l.readlines()
    ...
    def initUI(self):
        ...
        self.pushButton.setGeometry(
            QtCore.QRect(self.lab[1] * 46, self.lab[0] * 1, 42, 54)
        )
        icon = QtGui.QIcon()
        icon.addPixmap(
            QtGui.QPixmap(os.path.join(self.image, "player.png")),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off,
        )
        ...
        self.pushButton2.setGeometry(
            QtCore.QRect(self.lab[1] * (50 + self.r_y), self.lab[0] * 1, 50, 54)
        )
        icon = QtGui.QIcon()
        icon.addPixmap(
            QtGui.QPixmap(os.path.join(self.image, "chase.png")),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off,
        )
        ...
        self.pushButton3.setGeometry(
            QtCore.QRect(self.lab[1] * 46, self.lab[0] * 43, 91, 41)
        )
        font = QtGui.QFont()
        ...
        self.label.setGeometry(
            QtCore.QRect(self.lab[1] * 46, self.lab[0] * 10, 111, 191)
        )
        font = QtGui.QFont()
        font.setFamily("Serif")
        font.setPointSize(6)
        ...
        self.label.setText(
            _translate(
                "Form",
                '<html><head/><body><p><span style=" font-size:10pt;">CLIQUE </span></p><p><span style=" font-size:10pt;">NO RATO </span></p><p><span style=" font-size:10pt;">OU NO</span></p><p><span style=" font-size:10pt;">QUEIJO</span></p><p><span style=" font-size:10pt;">PARA </span></p><p><span style=" font-size:10pt;">SELECIONAR </span></p><p><span style=" font-size:10pt;">SUA POSIÇÃO</span></p></body></html>',
                None,
            )
        )
    ...
    def press_button_start(self):
        if self.rato[2] and self.queijo[2]:
            ...
            msg.setText("Por favor selecione a posição do rato e do queijo!")
            ...
            for j in range(self.lab[1]):
                if self.lab[2][i][j] == -1:
                    qp.drawPixmap(
                        j * 45,
                        i * 49,
                        QtGui.QPixmap(os.path.join(self.image, "block.png")),
                    )

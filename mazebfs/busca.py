    ...
    def buscar(self):
        ...
        while self.fronteira != []:
            ...
            for i in range(4):
                ...
                if (
                    self.rato.pos_x > -1
                    and self.rato.pos_y > -1
                    and self.rato.pos_x < self.lab.alt
                    and self.rato.pos_y < self.lab.larg
                ):
                    if (
                        self.lab.form[self.rato.pos_x][self.rato.pos_y] != -1
                        and not vis[self.rato.pos_x][self.rato.pos_y]
                    ):
